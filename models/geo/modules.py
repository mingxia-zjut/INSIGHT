...
from models.geotransformer.utils.point_cloud_utils import pairwise_distance, apply_transform
from models.geotransformer.utils.torch_utils import index_select
from models.geotransformer.modules.attention.rpe_attention import GeometricTransformer
from models.geotransformer.modules.attention.positional_embedding import SinusoidalPositionalEmbedding
from models.geotransformer.modules.registration.modules import WeightedProcrustes
...
class GeometricTransformerModule(nn.Module):
    ...
    def forward(self, ref_points, src_points, ref_feats, src_feats, base, name0, name1, ref_masks=None, src_masks=None):
        r"""
        ...
        ref_feats, src_feats = self.transformer(
            ref_points, src_points, ref_feats, src_feats, ref_embeddings, src_embeddings, masks0=ref_masks, masks1=src_masks
        )
